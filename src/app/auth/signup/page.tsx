...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-deep-pine flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-mint-bloom/10 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-1/4 left-1/4 w-[500px] h-[500px] bg-cyan-900/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-display text-cream-white font-semibold">Join AnatomyWorld</h1>
          <p className="text-soft-pistachio/60 text-sm mt-2">Create an account to save your studies.</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1">
            <label className="text-xs font-mono uppercase tracking-wider text-soft-pistachio/60 ml-1">Full Name</label>
        ...
        <p className="text-center text-xs text-soft-pistachio/50 mt-6">
          ...
          <Link href="/auth/login" className="text-mint-bloom hover:underline">
            Log in
          </Link>
        </p>
      </motion.div>
